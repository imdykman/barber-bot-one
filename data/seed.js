...
const services = [
  ...
  // Окрашивание
  {
    ...
    description: 'Однотонное окрашивание',
  },
  {
    ...
    description: 'Airtouch, балаяж, шатуш',
  },
  {
    name: 'Мелирование',
    category: 'Окрашивание',
    ...
    description: 'Классическое или современное мелирование',
  },
  ...
  // Укладки
  {
    ...
    price_max: 2000,
    duration_minutes: 45,
    description: 'Повседневная или вечерняя укладка',
  },
  {
    ...
    price_max: 5000,
    duration_minutes: 90,
    description: 'Причёска для особого случая',
  },
  ...
  // Уход
  {
    ...
    price_max: 3000,
    duration_minutes: 60,
    description: 'Маски, восстановление, ботокс',
  },
  {
  ...
  },
  {
    ...
    price_max: 1500,
    duration_minutes: 45,
    description: 'Бритьё опасной бритвой',
  },
];
...
const masters = [
  // Центральный филиал
  {
    ...
    experience: 7,
    description: 'Специализация: женские стрижки, окрашивание',
  },
  {
    branch: 'Центральный филиал',
    name: 'Дмитрий Волков',
    specialty: 'Барбер',
    experience: 5,
    description: 'Мужские стрижки, оформление бороды',
  },
  {
    branch: 'Центральный филиал',
    name: 'Елена Морозова',
    specialty: 'Колорист',
    experience: 10,
    description: 'Сложные окрашивания, мелирование',
  },

  // Северный филиал
  {
    branch: 'Северный филиал (Уралмаш / Эльмаш)',
    name: 'Мария Кузнецова',
    specialty: 'Стилист',
    experience: 6,
    description: 'Женские стрижки, укладки',
  },
  {
    branch: 'Северный филиал (Уралмаш / Эльмаш)',
    name: 'Антон Васильков',
    specialty: 'Барбер',
    experience: 4,
    description: 'Мужские стрижки, бритьё',
  },

  // Южный филиал
  {
    branch: 'Южный филиал (Ботаника / Чкаловский)',
    name: 'Ольга Новикова',
  ...
  },
  {
    ...
    specialty: 'Барбер',
    experience: 6,
    description: 'Мужской зал, классические стрижки',
  },
  {
    branch: 'Южный филиал (Ботаника / Чкаловский)',
    ...
    specialty: 'Колорист',
    experience: 9,
    description: 'Сложные окрашивания, восстановление',
  },
];
...
const masterServicesMap = {
  ...
  'Антон Васильков': ['Мужская стрижка', 'Детская стрижка', 'Стрижка бороды', 'Королевское бритьё'],
  'Ольга Новикова': [
    'Женская стрижка',
    'Мужская стрижка',
    'Окрашивание в один тон',
...
for (const [masterName, serviceNames] of Object.entries(masterServicesMap)) {
  ...
  for (const serviceName of serviceNames) {
    ...
    if (!serviceId || !service) {
      console.log(`?? Пропущено: ${masterName} ? ${serviceName} (не найдено)`);
      continue;
    }
...
console.log(`? Всего добавлено связей: ${masterServicesCount}`);
